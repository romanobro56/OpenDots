    ...
    <section id="early-access" className="bg-navy py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="font-black text-3xl sm:text-4xl lg:text-5xl text-cream mb-4">
          ...
          {success ? (
            <div className="bg-cream/10 rounded-3xl p-10 border border-gold/30">
              ...
              <p className="font-bold text-2xl text-gold mb-2">You&apos;re on the list.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full px-8 py-4 rounded-full bg-coral text-white font-bold text-lg hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer"
              >
          ...
          <p className="mt-8 text-cream/50 text-sm italic font-[Merriweather]">
