      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-display font-extrabold text-xl text-cream">OpenDots</span>
          </div>
          ...
          {/* Tagline */}
          <p className="text-cream/40 text-sm italic">Feel the world around you</p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-cream/10 text-center">
          ...
          <p className="text-cream/20 text-xs mt-2">
            © {new Date().getFullYear()} OpenDots. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
