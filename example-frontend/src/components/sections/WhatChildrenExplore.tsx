  ...
  return (
    <section ref={ref} className="bg-cream py-24 lg:py-32">
      <div className="container mx-auto px-6">
        <h2
          className={`font-display font-black text-3xl sm:text-4xl lg:text-5xl text-navy text-center mb-6 transition-all duration-700 ${
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
          {cards.map((card, i) => (
            <div
              key={i}
              className={`bg-background rounded-3xl p-8 shadow-md hover:shadow-xl transition-all duration-500 group ${
            ...
            >
              ...
              <h3 className="font-display font-extrabold text-xl text-navy mb-3">{card.title}</h3>
...
export default WhatChildrenExplore;
